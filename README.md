...
[![Python 3.8+](https://img.shields.io/badge/python-3.8%2B-blue.svg)](https://www.python.org/) [![License: MIT](https://img.shields.io/badge/license-MIT-green.svg)](LICENSE) [![Hosted on Synexa](https://img.shields.io/badge/hosted%20on-Synexa-6366f1.svg)](https://synexa.ai/explore/pixverse/pixverse-v6)
...
> **Try it now:** [https://synexa.ai/explore/pixverse/pixverse-v6](https://synexa.ai/explore/pixverse/pixverse-v6) — the hosted model behind this client. New accounts get a free trial credit.
...
|---|---|---|---|
| [`pixverse/pixverse-v6`](https://synexa.ai/explore/pixverse/pixverse-v6) | image-to-video | PixVerse V6 animates a still image into stylised or realistic video, with optional audio. | $0.025 |
